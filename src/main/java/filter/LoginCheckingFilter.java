...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = { 
				@WebInitParam(name = "mustLogin1", value = "/controller/*"), 
				@WebInitParam(name = "mustLogin2", value = "/dao/*"), 
				@WebInitParam(name = "mustLogin3", value = "/dao.impl/*"),
				@WebInitParam(name = "mustLogin4", value = "/filter/*"),			
				@WebInitParam(name = "mustLogin5", value = "/service/*"),			
				@WebInitParam(name = "mustLogin6", value = "/fservice.impl/*"),			
		})
