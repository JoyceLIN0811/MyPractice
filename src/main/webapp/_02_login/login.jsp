...
<body>
	<main layout:fragment="content">
		<article class="container" style="padding-top: 3%;">
			<header class="row">
				<blockquote class="flow-text left" th:text="${header}">
					...
					<div class="row">
						<div class="col s12">
							<label> 帳號: <input type="text" name="email"
								maxlength="30" data-length="30" required="required" />
							</label>
						</div>
					</div>
					<div class="row">
						<div class="col s12">
							<label> 密碼: <input type="password" name="password"
								maxlength="15" data-length="15" required="required" />
							</label>
						</div>
					</div>
					<div class="row">
...
<!-- 							<button class="btn" type="button" name="Register" onclick="location.href='/_01_register/register.jsp'">註冊</button> -->
							<button class="btn" type="button" name="Register"><a href="<c:url value='/_01_register/register.jsp' />" style="color: white">註冊</a></button>
						</div>
					</div>
